            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="fotoProduk" alt="" />
                </div>
                <div class="product-thumbs">
                  ...
                  >
                    <div
                      class="pt"
                      @click="changeImage(thumbnail[0])"
                      :class="thumbnail[0] == fotoProduk ? 'active' : ''"
                    >
                    ...
                    <div
                      class="pt"
                      @click="changeImage(thumbnail[1])"
                      :class="thumbnail[1] == fotoProduk ? 'active' : ''"
                    >
                    ...
                    <div
                      class="pt"
                      @click="changeImage(thumbnail[2])"
                      :class="thumbnail[2] == fotoProduk ? 'active' : ''"
                    >
                    ...
                    <div
                      class="pt"
                      @click="changeImage(thumbnail[3])"
                      :class="thumbnail[3] == fotoProduk ? 'active' : ''"
                    >
